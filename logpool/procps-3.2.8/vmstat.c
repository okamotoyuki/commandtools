...
//		printf("%13lu milli spent IO\n",milli_spent_IO);
		...
		snprintf(line[1], LINELEN, "%13lu total reads\n",reads);
		snprintf(line[2], LINELEN, "%13lu merged reads\n",merged_reads);
		snprintf(line[3], LINELEN, "%13lu read sectors\n",read_sectors);
		snprintf(line[4], LINELEN, "%13lu milli reading\n",milli_reading);
		snprintf(line[5], LINELEN, "%13lu writes\n",writes);
		snprintf(line[6], LINELEN, "%13lu merged writes\n",merged_writes);
		snprintf(line[7], LINELEN, "%13lu written sectors\n",written_sectors);
		snprintf(line[8], LINELEN, "%13lu milli writing\n",milli_writing);
